...
public class BigBananaModel extends EntityModel<BigBanana> {
    ...
    public BigBananaModel() {
        this(0.0F);
    }

    public BigBananaModel(float f1) {
    ...
    public void render(BigBanana banana, float float_1, float float_2, float float_3, float float_4, float float_5,
            float float_6) {
    ...
    public void setAngles(BigBanana banana, float float_1, float float_2, float float_3, float float_4, float float_5,
            float float_6) {
    }
}